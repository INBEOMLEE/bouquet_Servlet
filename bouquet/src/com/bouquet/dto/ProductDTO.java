...
public class ProductDTO {
	...
	public ProductDTO(String p_code, String p_type, String p_name, int p_price, String p_img, int p_cnt, int p_good,
			Date p_indate) {
		super();
		this.p_code = p_code;
		this.p_type = p_type;
	...
	public String toString() {
		return "ProductDTO [p_code=" + p_code + ", p_type=" + p_type + ", p_name=" + p_name + ", p_price=" + p_price
